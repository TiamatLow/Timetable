...
public class TableMainLayout extends RelativeLayout {
        ...
        LLListInterface<Timetable> sampleObjects = this.sampleObjects();
        ...
        LLListInterface<Timetable> sampleObjects(){


            LLListInterface<Timetable> sampleObjects = new LLList<Timetable>();

            for(int x=1; x<=20; x++){

                Timetable sampleObject = new Timetable(
                        "DATE/TIME",
                        "MONDAY",
                        "TUESDAY",
                        "WEDNESDAY",
        ...
        private void generateTableC_AndTable_B(){
            ...
            for(int i = 0; i < sampleObjects.size(); i++){
                Timetable sampleObject = sampleObjects.get(i);
        ...
        TableRow tableRowForTableC(Timetable sampleObject){
        ...
        TableRow taleRowForTableD(Timetable sampleObject){
